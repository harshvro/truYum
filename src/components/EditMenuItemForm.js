...
const EditMenuItemForm = ({ item, onSave, onCancel }) => {
  const [formData, setFormData] = useState({
    ...
    date_of_launch: item.date_of_launch || '',
    category: item.category || 'Starter', // Default value for category
    free_delivery: item.free_delivery !== undefined ? item.free_delivery : false,
  });
